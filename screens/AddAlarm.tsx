    ...
    return (
        <ScrollView style={[styles.amcontainer, { backgroundColor: '#4A628A', borderTopLeftRadius: 50, borderTopRightRadius: 50, paddingTop: 30 }]}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20 }}>
                ...
                <TouchableOpacity style={{ backgroundColor: "transparent" }} onPress={handleSave}>
            ...
            <View style={{ padding: 25 }}>
                ...
                <View style={styles.settingsContainer}>
                    ...
                    <View style={styles.settingContainer}>
                        <Text style={[styles.settingText, { marginLeft: 10 }]}>Alarm sound</Text>
                        <Switch
                            value={alarmSound}
                    ...
                    <View style={styles.amseparator} />
                    <View style={styles.settingContainer}>
                        <Text style={[styles.settingText, { marginLeft: 10 }]}>Vibration</Text>
                        <Switch
                            value={vibration}
